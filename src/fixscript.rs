...
lazy_static! {
    static ref DEFAULT_GROUP: Group = Group {
        dir: path::PathBuf::from(CARGO_MANIFEST_DIR).join("fixtures"),
        getenv,
    };
}
...
impl Group {
    ...
    pub(crate) fn open<P: AsRef<path::Path>>(&self, script_name: P) -> Result<Fixture> {
